...
public extension UIAlertController {
    ...
    static func showAlert(message: String, in viewController: UIViewController) {
        ...
        alert.addAction(UIAlertAction(title:NSLocalizedString("", comment: "continue"), style: .cancel))
    ...
    static func showConfirm(title: String, message: String, in viewController: UIViewController,
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("", comment: "cancel") ,style: .cancel))
        alert.addAction(UIAlertAction(title: NSLocalizedString("", comment: "continue"), style: .default, handler: confirm))
        viewController.present(alert, animated: true)
    }
...
public extension UIPopoverPresentationController {
     func setSourceView(_ sourceView:PopOverPresentationSourceView) {
        //For iPad support
...
public extension UIAlertController {
    ...
    @discardableResult
     static func present(actions: [UIAlertAction], title: String? = nil, message: String? = nil, sourceView: PopOverPresentationSourceView, style: Style = .actionSheet, appendsCancelAction: Bool = true) -> UIAlertController {
...
public extension UIAlertController {
    ...
    @discardableResult
    static func present(options: [String], title: String? = nil, message: String? = nil, sourceView: PopOverPresentationSourceView, _ handler: @escaping (_ option: String) -> Void) -> UIAlertController {
